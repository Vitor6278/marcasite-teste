        ...
        <div class="col-md-8"> 
            <div class="card">
                <div class="card-header bg-primary text-white"> 
                    <h4 class="mb-0">Adicionar Novo Curso</h4>
                </div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('admin.cursos.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('valor') is-invalid @enderror" id="valor" name="valor" value="{{ old('valor') }}" required step="0.01" min="0">
                             @error('valor')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('data_fim') is-invalid @enderror" id="data_fim" name="data_fim" value="{{ old('data_fim') }}" required>
                             @error('data_fim')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('quantidade_maxima_inscritos') is-invalid @enderror" id="quantidade_maxima_inscritos" name="quantidade_maxima_inscritos" value="{{ old('quantidade_maxima_inscritos') }}" required min="1">
                        ...
                        <div class="mb-3">
                            <label for="arquivo_material" class="form-label">Arquivo com Material (Opcional - PDF, ZIP, DOC, DOCX - Máx 10MB)</label>
                        ...
                        <div class="d-grid gap-2"> 
                           <button type="submit" class="btn btn-primary btn-lg">Salvar Curso</button>
                        </div>
